                    ...
                    <div className="hidden md:flex w-full justify-between items-center">
                        ...
                        <div className="w-full flex items-center justify-end" id="Links">
                            <ul className="list-none flex justify-center items-center">
                                ...
                                <Link to={'login'}><li className="mx-4 cursor-pointer relative group">Login
                                    <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-black transition-all duration-300 group-hover:w-full"></span>
                                </li>
                                </Link>
                                
                            </ul>
                            <Link to={`${isLoggedIn ? 'player-profile' : 'login'}`} className="border-2 relative border-black p-2 rounded-full transition-all duration-500 text-black group hover:bg-black hover:text-white cursor-pointer">
